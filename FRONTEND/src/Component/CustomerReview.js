        ...
        <tbody>
            ...
            <tr key={reviewAdd.id} class="bg-white border-b border-gray-200 hover:bg-gray-50">
                ...
                <div >
                    ...
                    <button onClick={() => onDeleteClick(reviewAdd._id)} class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
                        Delete
                    </button>
                </div></td>
            </tr>
