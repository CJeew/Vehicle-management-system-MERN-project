    ...
    return (
        <div className="flex justify-left mt-20 ml-14 h-screen text-white">
         <div className="w-1/2 text-left">
            ...
            <br />
            <p className="text-xl opacity-90 mt-5">Transform the way you drive with Ryome Autocare, the pinnacle of accuracy in auto repair and maintenance.  Our expert technicians ensure your vehicle runs at its peak, delivering unparalleled accuracy and reliability. Experience the pinnacle of automotive care with Ryome Autocare today.</p>
            <div className="mt-16 ">
