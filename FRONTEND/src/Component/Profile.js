                    ...
                    <tr key={customer.id} class="bg-white border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-start gap-2">
                                {/*Edit booking button */}
                                <a href={'/editBookRead/${bookings._id}'} type="button" class="bg-transparent hover:bg-green-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
                                    Edit
                                </a>
